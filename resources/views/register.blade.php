                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="{{ route('register') }}"
                                        ...
                                        @csrf
                                        <div class="col-12">
                                            <label for="yourName" class="form-label">Choose Name</label>
                                            <select name="id_pegawai" class="form-control" id="yourName" required>
                                            ...
                                            <div class="invalid-feedback">Please, choose your name!</div>
                                        </div>
                                        <div class="col-12">
                                            <label for="yourRole" class="form-label">Choose Role</label>
                                            <select name="hak_akses" class="form-control" id="yourRole" required>
                            ...
                            <div class="credits">
                                Copyright 2024 | <a href="https://github.com/NoSpectr">NoSpectr</a>
                            </div>
